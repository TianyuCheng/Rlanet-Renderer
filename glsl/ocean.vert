...
vec3 gerstnerWaves(vec2 pos) {
    ...
    steepness = 2.3;
    amplitude = 10.2; speed = 400.0; waveLength = 1000.0; direction = normalize(vec2(0.2, -0.3));
    ...
    steepness = 2.5;
    amplitude = 12.0; speed = 300.0; waveLength = 900.0; direction = normalize(vec2(0.2, 0.9));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);

    steepness = 2.1;
    amplitude = 11.0; speed = 250.0; waveLength = 1100.0; direction = normalize(vec2(-0.5, 1.9));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);

    steepness = 2.4;
    amplitude = 11.0; speed = 350.0; waveLength = 1200.0; direction = normalize(vec2(-1.2, 0.9));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);
    ...
    steepness = 1.0;
    amplitude = 6.0; speed = 50.0; waveLength = 320.0; direction = normalize(vec2(0.1, -0.3));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);

    steepness = 1.1;
    amplitude = 4.0; speed = 60.0; waveLength = 410.0; direction = normalize(vec2(0.3, -0.8));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);

    steepness = 1.2;
    amplitude = 3.3; speed = 40.0; waveLength = 310.0; direction = normalize(vec2(0.6, 0.5));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);

    steepness = 1.1;
    amplitude = 3.9; speed = 70.0; waveLength = 210.0; direction = normalize(vec2(0.6, 0.9));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);

    steepness = 1.4;
    amplitude = 4.9; speed = 50.0; waveLength = 270.0; direction = normalize(vec2(-0.1, 0.7));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);

    steepness = 1.2;
    amplitude = 3.9; speed = 60.0; waveLength = 170.0; direction = normalize(vec2(0.1, 0.3));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);

    steepness = 1.6;
    amplitude = 3.3; speed = 40.0; waveLength = 220.0; direction = normalize(vec2(0.9, -0.3));
    sum += gerstnerWave(pos, steepness, amplitude, speed, waveLength, direction);
    normal += computeGerstnerNormal(pos, steepness, amplitude, speed, waveLength, direction);
