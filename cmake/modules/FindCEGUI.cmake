...
find_path(CEGUI_INCLUDE_DIR CEGUI/CEGUI.h
    HINTS $ENV{CEGUIDIR}
        ${PC_CEGUI_INCLUDEDIR}
    PATH_SUFFIXES = cegui-0 include cegui/include
    PATHS
    ~/Library/Frameworks
    /Library/Frameworks
    /usr/local/include/
...
find_library(CEGUIOPENGL_LIBRARY
  CEGUIOpenGLRenderer
  HINTS
  $ENV{CEGUIDIR}
  ${PC_CEGUI_LIBDIR}
...
set(CEGUI_LIBRARIES ${CEGUI_LIBRARY} ${CEGUIOPENGL_LIBRARY})
set(CEGUI_INCLUDE_DIRS ${CEGUI_INCLUDE_DIR})

include(FindPackageHandleStandardArgs)
#Set vars
find_package_handle_standard_args(CEGUI DEFAULT_MSG
                                    CEGUI_LIBRARY CEGUIOPENGL_LIBRARY CEGUI_INCLUDE_DIR)
